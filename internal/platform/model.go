...
func (m *PlatformConfigModel) ToDomain() *core.PlatformConfig {
	return &core.PlatformConfig{
		...
		APIBaseURL:  convertNullStringToString(m.APIBaseURL),
		APIToken:    convertNullStringToString(m.APIToken),
...
func FromDomain(config *core.PlatformConfig) *PlatformConfigModel {
	return &PlatformConfigModel{
		...
		APIBaseURL:  convertStringToNullString(config.APIBaseURL),
		APIToken:    convertStringToNullString(config.APIToken),
